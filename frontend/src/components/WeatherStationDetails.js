...
function WeatherStationDetails({ authToken, onLogout, username, isSuperuser, navigateTo, isSidebarMinimized, setIsSidebarMinimized }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-gradient-to-r from-orange-600 to-amber-700 shadow-lg -mx-4 lg:-mx-8 -mt-4 lg:-mt-8">
        <div className="px-4 lg:px-8 py-8 lg:py-12">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between space-y-4 lg:space-y-0 lg:space-x-4">
            ...
            {/* Botón de cálculo con estilo mejorado */}
            <div className="flex items-center space-x-4">
              <button 
                onClick={calculateWeatherData}
                disabled={weatherLoading || !filters.institutionId}
      ...
      {/* Sección de Estaciones Meteorológicas */}
      <section className="mb-6 lg:mb-8">
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl border border-white/30 overflow-hidden">
          ...
          <div className="p-4 lg:p-8">
            ...
            {weatherLoading && (
              <div className="flex items-center justify-center py-8 lg:py-12 transition-opacity duration-300 ease-in-out">
                <div className="flex flex-col items-center">
                  ...
                  <p className="mt-1 lg:mt-2 text-sm text-gray-500">Procesando indicadores climáticos</p>
                </div>
              </div>
            )}
            ...
            {!weatherData?.results?.length && !weatherLoading && !weatherError && (
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-4 lg:p-6 shadow-sm">
                <div className="flex items-center">
                  ...
                  <div className="ml-3 lg:ml-4">
                    <h3 className="text-base lg:text-lg font-semibold text-blue-800 mb-1">Configura los filtros para comenzar</h3>
                    <p className="text-blue-700 text-sm lg:text-base">Selecciona una institución y estación meteorológica para ver los datos y gráficos</p>
                  </div>
                </div>
              </div>
            )}
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl border border-white/30 overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-green-600 to-emerald-700 px-4 lg:px-8 py-4 lg:py-6">
              <div className="flex flex-col lg:flex-row lg:items-center space-y-3 lg:space-y-0 lg:space-x-4">
                ...
                <div>
                  <h2 className="text-lg lg:text-2xl font-bold text-white">Indicadores Clave (KPIs)</h2>
                  <p className="text-green-100 mt-1 text-sm lg:text-base">Resumen de métricas meteorológicas principales</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 lg:p-8">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 lg:gap-6">
                {Object.keys(kpiData).map((key) => {
                  ...
                  return <KpiCard key={key} {...item} description={item.change} icon={item.icon} />;
                })}
              </div>
            </div>
          </div>
      ...
      {weatherData && weatherData.results && weatherData.results.length > 0 && (
        <section className="mb-6 lg:mb-8">
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl border border-white/30 overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-indigo-700 px-4 lg:px-8 py-4 lg:py-6">
              <div className="flex flex-col lg:flex-row lg:items-center space-y-3 lg:space-y-0 lg:space-x-4">
                <div className="p-2 lg:p-3 bg-white/20 rounded-xl self-start lg:self-auto">
                  <svg className="w-6 h-6 lg:w-7 lg:h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                ...
                <div>
                  <h2 className="text-lg lg:text-2xl font-bold text-white">Análisis Gráfico</h2>
                  <p className="text-blue-100 mt-1 text-sm lg:text-base">Visualización de datos meteorológicos por categoría</p>
                </div>
              </div>
            </div>
                  ...
                  >
                    <div className="flex items-center">
                      <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66-1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 6.34-1.41-1.41"/><path d="m17.66 6.34-1.41-1.41"/></svg>
                      Irradiancia
                    </div>
                  </button>
                  <button
