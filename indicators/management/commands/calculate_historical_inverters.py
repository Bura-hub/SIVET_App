...
import pytz
from indicators.tasks import calculate_inverter_data

class Command(BaseCommand):
    help = 'Calcula indicadores históricos de inversores para un rango de fechas específico'
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stdout.write(
                self.style.SUCCESS(
                    f'🚀 Iniciando cálculo histórico de inversores...\n'
            ...
            self.stdout.write(
                self.style.WARNING(
                    ...
                    f'3. Usa el comando: python manage.py shell -c "from indicators.models import InverterIndicators; print(InverterIndicators.objects.count())"'
                )
            )
